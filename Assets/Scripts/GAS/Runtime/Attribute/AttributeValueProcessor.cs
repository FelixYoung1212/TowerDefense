...
namespace GAS.Runtime
{
    ...
    public class AttributeValueProcessor
    {
        ...
        private OnPreValueChange m_OnPreValueChange;
        private event OnPostValueChange m_OnPostValueChange;
        ...
        public void Dispose()
        {
            m_OnPreValueChange = null;
            m_OnPostValueChange = null;
        ...
        private void OnAttributeChanged(AttributeBase attribute, float attrOldValue, float attrNewValue)
        {
            ...
            if (m_OnPreValueChange != null)
            {
                newValue = m_OnPreValueChange(this, oldValue, newValue);
            }
            ...
            Value = newValue;
            m_OnPostValueChange?.Invoke(this, oldValue, newValue);
        }
